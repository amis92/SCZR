...
public class BusStop
{
    ...
    /**
     * Adds bus stop with given parameters. Name can be null. In such case
     * default bus stop name will be assigned.
     * 
     * @param position
     *            position of bus stop
     * @param name
     *            bus stop name
    ...
    public static List<BusStopsListEvent.BusStop> getBusStopsList()
    {
        ...
        for (BusStop busStop : busStops)
        {
            ...
            {
                busStopsList.add(new BusStopsListEvent.BusStop(busStop.getId(),
                        busStop.getName()));
            }
        }
        return busStopsList;
    ...
    /**
     * Enqueues bus to the bus stop. Sends BusArrivesAtBusStopEvent to the
     * passenger module.
     * 
     * @param bus
     *            bus to be enqueued
     * @param busStop
     *            bus stop bus to be queued to
     */
    public static void enqueueBus(Bus bus, BusStop busStop)
    {
        // TODO
        // Simulation.getInstance().send(new BusArrivalEvent(
    ...
    /**
     * Returns bus stop closest to the given position. If position is larger
     * than the furthest bus stop, a final terminus is returned.
     * 
     * @param position
     *            searched position
